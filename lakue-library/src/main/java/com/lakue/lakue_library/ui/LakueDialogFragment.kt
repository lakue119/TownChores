...
abstract class LakueDialogFragment<B : ViewDataBinding, VM : LakueViewModel>(private val layoutId: Int) :
    DialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel {
            liveToast.observe(viewLifecycleOwner) { this@LakueDialogFragment.showToast(it) }
        }
    }
