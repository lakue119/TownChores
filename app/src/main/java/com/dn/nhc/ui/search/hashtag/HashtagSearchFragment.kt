package com.dn.nhc.ui.search.hashtag
...
import com.dn.nhc.databinding.FragmentHashtagSearchBinding
...
@AndroidEntryPoint
class HashtagSearchFragment :
    NeighborHoodChoresFragment<FragmentHashtagSearchBinding, SearchViewModel>(R.layout.fragment_hashtag_search),
    ...
    companion object {
        ...
        @JvmStatic
        fun newInstance() = HashtagSearchFragment()
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.apply {
            srlPheed.setOnRefreshListener(this@HashtagSearchFragment)
    ...
    fun getPheedList() {
        ...
        rvloading = true
        viewModel.getSearchHashTagPheedList(
